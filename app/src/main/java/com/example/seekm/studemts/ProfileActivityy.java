...
public class ProfileActivityy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activityy_profile);
        ...
        if(user_id==null){
            Intent intent = new Intent(ProfileActivityy.this,MainActivity.class);
...
//        Log.e("user_id is",user_id);
        ...
        mProgressDialog=new ProgressDialog(ProfileActivityy.this);
                ...
                mFriendDatabase.child(user_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        mfriendReqReference.child(mFirebaseUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            @Override
                            public void onCancelled(DatabaseError databaseError) {
                                Toast.makeText(ProfileActivityy.this, "Error fetching Friend request data", Toast.LENGTH_SHORT).show();
                            }
                        });
        ...
        mProfileSendReqButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mUserId.equals(user_id)){
                    Toast.makeText(ProfileActivityy.this, "Cannot send request to your own", Toast.LENGTH_SHORT).show();
                    return ;
                }
                    ...
                    mRootReference.updateChildren(friendMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            ...
                            if(databaseError==null){
                                ...
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(ProfileActivityy.this, "Error is " +databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                    ...
                    mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                        ...
                        public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                            if(databaseError == null){
                                ...
                                mProfileSendReqButton.setText("Send Friend Request");
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(ProfileActivityy.this, "Successfully Unfriended...", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                mProfileSendReqButton.setEnabled(true);
                                Toast.makeText(ProfileActivityy.this, "Cannot Unfriend..Contact Kshitiz..", Toast.LENGTH_SHORT).show();
                ...
                mRootReference.updateChildren(valueMap, new DatabaseReference.CompletionListener() {
                    ...
                    public void onComplete(DatabaseError databaseError, DatabaseReference databaseReference) {
                        if(databaseError == null){
                            ...
                            mProfileSendReqButton.setEnabled(true);
                            Toast.makeText(ProfileActivityy.this, "Cannot decline friend request...", Toast.LENGTH_SHORT).show();
