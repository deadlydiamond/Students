...
public class Verifier extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //underlining
        SpannableString content = new SpannableString("Or connect with social");
        content.setSpan(new UnderlineSpan(), 0, content.length(), 0);
        mSocial.setText(content);

        //calling social function
        Social();
