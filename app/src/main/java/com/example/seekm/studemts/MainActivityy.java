...
import com.example.seekm.studemts.Fragments.MyFragmentPagerAdapter;
...
public class MainActivityy extends AppCompatActivity {
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder=new AlertDialog.Builder(MainActivityy.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId()==R.id.settings){
            Intent intent=new Intent(MainActivityy.this,SettingActivity.class);
            startActivity(intent);
        }
        if(item.getItemId()==R.id.allUsers){
            Intent intent=new Intent(MainActivityy.this,UserActivity.class);
            startActivity(intent);
        }
            ...
            mDatabaseReference.child(mauth.getCurrentUser().getUid()).child("online").setValue(ServerValue.TIMESTAMP).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(MainActivityy.this, "Try again..", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
