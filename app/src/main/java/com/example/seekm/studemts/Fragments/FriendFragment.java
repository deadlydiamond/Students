package com.example.seekm.studemts.Fragments;
/*
...
import com.example.seekm.studemts.ChatActivity;
import com.example.seekm.studemts.ProfileActivityy;
                            ...
                            public void onClick(View v) {
                                ...
                                builder.setItems(options,new AlertDialog.OnClickListener(){
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        if(which == 0){
                                            Intent intent=new Intent(getContext(), ProfileActivityy.class);
